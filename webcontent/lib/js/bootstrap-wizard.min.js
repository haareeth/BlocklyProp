(function(e) {
    ...
    var t = function(e, t, n, r, i) {
        ...
        this.next = i;
        this.el = t;
        this.title = t.find("h3").first().text();
        this.name = t.data("cardname") || this.title;
        this.nav = this._createNavElement(this.title, n);
    ...
    t.prototype = {select: function() {
            ...
            var e = this.wizard;
            e.backButton.toggleClass("disabled", this.index == 0);
            if (this.index >= e._cards.length - 1) {
                this.log("on last card, changing next button to submit");
                e.changeNextButton(e.args.buttons.submitText, "btn-success");
                e._readyToSubmit = true;
                e.trigger("readySubmit")
            } else {
                e._readyToSubmit = false;
                e.changeNextButton(e.args.buttons.nextText, "btn-primary")
            }
            return this
        }, _createNavElement: function(t, n) {
            var r = e('<li class="wizard-nav-item"></li>');
            var i = e('<a class="wizard-nav-link"></a>');
            i.data("navindex", n);
            r.append(i);
            i.append('<span class="glyphicon glyphicon-chevron-right"></span> ');
            i.append(t);
            return r
            ...
            var r;
            var i = this.el.children("h3").first().next("div.alert");
            if (i.length == 0) {
                if (!n) {
                    return this
                }
                ...
                r.addClass("alert");
                r.addClass("hide");
                r.insertAfter(this.el.find("h3").first())
            } else {
            ...
            if (n) {
                if (t != null) {
                    this.log("setting alert msg to", t);
                    r.html(t)
                }
                r.show()
            } else {
            ...
            e = e.toLowerCase();
            this.log("looking for listener " + e);
            ...
            if (t) {
                ...
                this.log("didn't find listener " + e)
            }
        }, problem: function(e) {
            ...
            this.el.find("[data-validate]").each(function(r, i) {
                n.log("validating individiual inputs");
                i = e(i);
                var s = i.data("validate");
                if (!s) {
                    return
                }
                var o = {status: true, title: "Error", msg: ""};
                var u = window[s](i);
                e.extend(o, u);
                if (e("#btn-" + i.attr("id")).length === 1) {
                    i = e("#btn-" + i.attr("id"))
                }
                if (!o.status) {
                    t = true;
                    i.parents("div.form-group").toggleClass("has-error", true);
                    if (e("#btn-" + i.attr("id")).length === 1) {
                        i = e("#btn-" + i.attr("id"))
                    }
                    n.wizard.errorPopover(i, o.msg)
                } else {
                    i.parents("div.form-group").toggleClass("has-error", false);
                    if (e("#btn-" + i.attr("id")).length === 1) {
                        i = e("#btn-" + i.attr("id"))
                    }
                    try {
            ...
            if (r) {
                ...
                if (!i)
                    t = true;
                this.log("after running html-embedded card validator, failures is", t)
            }
            ...
            if (!s)
                t = true;
            this.log("after running listener validator, failures is", t);
            var o = !t;
            if (o) {
            ...
            if (!window.console || !e.fn.wizard.logging) {
                return
            }
    ...
    Wizard.prototype = {log: function() {
            ...
            this.el = e(this.wizard_template.join("\n"));
            e("body").append(this.el);
            this.modal = this.el.modal({keyboard: this.args.keyboard, show: this.args.show, backdrop: this.args.backdrop});
            this.dimensions = {contentHeight: this.args.contentHeight, contentWidth: this.args.contentWidth};
            ...
            this.wizardCardContainer.append(this.markup.find(".wizard-card")).append(this.submitCards);
            ...
            this.closeButton.click(r);
            this.cancelButton.click(r);
            this.wizardSteps.on("click", "li.already-visited a.wizard-nav-link", this, function(t) {
            ...
            this.dimensions.offset = (e(window).height() - this.dialog.height()) / 2;
            this.dialog.css({"margin-top": this.dimensions.offset + "px", "padding-top": 0});
            this.modal.css("display", "")
        }, setTitle: function(e) {
            this.log("setting title to", e);
            this.modal.find(".wizard-title").first().text(e);
            return this
        }, setSubtitle: function(e) {
            this.log("setting subtitle to", e);
            this.modal.find(".wizard-subtitle").first().text(e);
            return this
        }, errorPopover: function(e, t, n) {
            this.log("launching popover on", e);
            n = typeof n !== "undefined" ? n : false;
            var r = e.popover({content: t, trigger: "manual", html: n, container: e.parents(".form-group")}).addClass("error-popover").popover("show").next(".popover");
            e.parents(".form-group").find(".popover").addClass("error-popover");
            this.popovers.push(e);
            return r
        }, destroyPopover: function(t) {
            t = e(t);
            try {
                t.popover("destroy")
            } catch (n) {
        ...
        }, hidePopovers: function(t) {
            this.log("hiding all popovers");
            var n = this;
            e.each(this.popovers, function(e, t) {
                n.destroyPopover(t)
            });
            this.modal.find(".has-error").removeClass("has-error");
            this.popovers = []
        }, eachCard: function(t) {
            e.each(this._cards, t);
            return this
        }, getActiveCard: function() {
            this.log("getting active card");
            var t = null;
            e.each(this._cards, function(e, n) {
                if (n.isActive()) {
                    t = n;
                    return false
                }
            ...
            this.log("adding listener to event " + e);
            this._events[e] = t;
            return this
        }, trigger: function() {
            var e = arguments[0];
            ...
            t.shift();
            t.unshift(this);
            this.log("firing event " + e);
            var n = this._events[e];
            if (n === undefined && this.wizard !== undefined) {
                n = this.wizard._events[e]
            }
            var r = null;
            if (typeof n == "function") {
                ...
                this.log("couldn't find an event handler for " + e)
            }
            return r
        }, reset: function() {
            this.log("resetting");
            ...
            if (n) {
                ...
                while (true) {
                    ...
                    if (r) {
                        ...
                        if (r.isDisabled()) {
                            this.log("card " + r.index + " is disabled/locked, continuing");
                            n = r;
                            continue
                        } else {
            ...
            if (n) {
                ...
                if (this.args.progressBarCurrent) {
                    this.percentComplete = e * 100 / this._cards.length;
                    this.updateProgressBar(this.percentComplete)
                } else {
                    var s = this.percentComplete;
                    this.percentComplete = e * 100 / this._cards.length;
                    this.percentComplete = Math.max(s, this.percentComplete);
                    this.updateProgressBar(this.percentComplete)
                }
                return n
            } else {
            ...
            this.log("updating progress to " + e + "%");
            this.progress.css({width: e + "%"});
            this.percentComplete = e;
            this.trigger("progressBar", e);
            if (e == 100) {
            ...
            var s = this;
            var o = this;
            o.log("Creating Cards");
            var u = this.modal.find(".wizard-cards .wizard-card");
            e.each(u, function(u, a) {
                a = e(a);
                n = i;
                i = new t(s, a, u, n, r);
                o._cards.push(i);
                ...
                o.modal.find(".wizard-steps .wizard-nav-list").append(i.nav)
            })
            ...
            if (t.length) {
                this.hideCards();
                this.el.find(".wizard-" + e).show()
            } else {
                this.log("couldn't find submit card " + e)
            }
        }, hideSubmitCard: function(e) {
            this.log("hiding " + e + " submit card");
            this.el.find(".wizard-" + e).hide()
            ...
            this.form.find('input[disabled][data-serialize="1"]').each(function() {
                formObj = {name: e(this).attr("name"), value: e(this).val()};
                t.push(formObj)
            });
            return t
        }, serialize: function() {
            ...
            this.form.find('input[disabled][data-serialize="1"]').each(function() {
                t = t + "&" + e(this).attr("name") + "=" + e(this).val()
            });
            return t
        }, find: function(e) {
            return this.modal.find(e)
            ...
            var e = this.getActiveCard();
            if (this._readyToSubmit && e.validate()) {
                this._submit()
            } else {
                e = this.incrementCard()
            }
            ...
            e.ajax({type: "POST", url: t.args.submitUrl, data: t.serialize(), dataType: "json"}).done(function(e) {
                t.submitSuccess();
                t.hideButtons();
                t.updateProgressBar(0)
            }).fail(function() {
                t.submitFailure();
                t.hideButtons()
            })
